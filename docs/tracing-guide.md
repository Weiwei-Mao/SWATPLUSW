...
For the source-aligned input-file map and per-file reference or stub links, use [`input-files.md`](input-files.md). For output-file classes and print controls, use [`output-files.md`](output-files.md). This guide stays focused on tracing how selected inputs move through readers, state, calculations, and outputs.
...
- Detailed note: [`inputs/simulation/file-cio.md`](inputs/simulation/file-cio.md)
- Input files map: [`input-files.md`](input-files.md)
- Basin control note: [`inputs/basin/codes-bsn.md`](inputs/basin/codes-bsn.md)
- Basin parameter note: [`inputs/basin/parameters-bsn.md`](inputs/basin/parameters-bsn.md)
- Output control note: [`inputs/simulation/print-prt.md`](inputs/simulation/print-prt.md)
- CO2/carbon input note: [`topics/co2-carbon-inputs.md`](topics/co2-carbon-inputs.md)
- Initial organic-mineral water note: [`inputs/initialization/om-water-ini.md`](inputs/initialization/om-water-ini.md)
- Object inventory note: [`inputs/simulation/object-cnt.md`](inputs/simulation/object-cnt.md)
...
The broader input inventory now lives in [`input-files.md`](input-files.md), with categorized stub and reference pages under [`inputs/`](inputs/). Output-file classes and starter output inventory live in [`output-files.md`](output-files.md). The next detailed tracing target is to follow one selected filename such as [`time.sim`](inputs/simulation/time-sim.md) from `file.cio` into its own reader and storage fields.
