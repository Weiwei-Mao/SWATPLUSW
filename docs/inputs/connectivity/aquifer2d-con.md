---
title: aquifer2d.con input file
...
Input file for connect; source slot aqu2d_con.
...
- Source inventory slot(s): `in_con%aqu2d_con = "aquifer2d.con"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `aquifer2d.con` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_con%aqu2d_con` defaulting to `aquifer2d.con`.
