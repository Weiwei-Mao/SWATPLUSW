...
| `lat` | Latitude of the station or object. | `35.52014` |
| `lon` | Longitude of the station or object. | `127.32787` |
| `elev` | Elevation of the station or object. | `113.51276` |
| `rtu` | Field named in the demo/source header; trace the reader for exact units and storage. | `1` |
...
| `out_tot` | Number of output or receiving commands listed for the object. | `2` |
