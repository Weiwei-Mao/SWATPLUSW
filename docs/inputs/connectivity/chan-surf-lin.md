---
title: chan-surf.lin input file
...
Input file for link; source slot chan_surf.


## Official SWAT+ Reference

- Official page: [chan_surf.lin](https://swatplus.gitbook.io/io-docs/introduction-1/connectivity/chan_surf.lin).
...
- Source inventory slot(s): `in_link%chan_surf = "chan-surf.lin"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `chan-surf.lin` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_link%chan_surf` defaulting to `chan-surf.lin`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/overbank_read.f90`.
