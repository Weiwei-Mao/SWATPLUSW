...
- Source inventory slot(s): `in_con%aqu_con = "aquifer.con"`.
...
Local demo evidence from `VSProj/SWAT/Osu_1hru/aquifer.con`:

- Title/comment line: `aquifer.con: written by SWAT+ editor v2.2.0 on 2023-03-22 04:25 for SWAT+ rev.60.5.4`.
- Observed header line: `id  name                gis_id          area           lat           lon          elev       aqu               wst       cst      ovfl      rule   out_tot       obj_typ    obj_id       hyd_typ          frac`.
- Nonblank records after the header: 1.
- First demo data record: `1  aqu001                   1      10.00000      35.64206     127.38513     322.26395         1    s35610n127290e         0         0         0         1          sdc         1           tot       1.00000`.
...
- Source slot: `in_con%aqu_con` defaulting to `aquifer.con`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/basin_read_objs.f90`, `SWATPLUS/swatplus/src/hyd_connect.f90`, `SWATPLUS/swatplus/src/swift_output.f90`.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/aquifer.con`.
