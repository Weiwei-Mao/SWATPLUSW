...
Input file for link; source slot aqu_cha.


## Official SWAT+ Reference

- Official page: [aqu_cha.lin](https://swatplus.gitbook.io/io-docs/introduction-1/connectivity/aqu_cha.lin).
- Official index note: This file is used to connect an aquifer to multiple channels.
...
- Source inventory slot(s): `in_link%aqu_cha = "aqu_cha.lin"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `aqu_cha.lin` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_link%aqu_cha` defaulting to `aqu_cha.lin`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/aqu2d_read.f90`, `SWATPLUS/swatplus/src/aqu_1d_control.f90`.
