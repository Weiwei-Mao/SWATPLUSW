...
- Official field metadata available: 17 field row(s); matched to 12 of 13 observed demo header field(s).
...
| `name` | Name of the object. | - | - | - | - | `hru0001` | official GitBook |
| `gis_id` | Object ID in QSWAT+. | - | - | - | - | `1` | official GitBook |
| `area` | Area of the object. | - | - | - | - | `10` | official GitBook |
| `lat` | Latitude of the object. | - | - | - | - | `35.65311` | official GitBook |
| `lon` | Longitude of the object. | - | - | - | - | `127.36763` | official GitBook |
| `elev` | Elevation of the object. | - | - | - | - | `350.96629` | official GitBook |
| `hru` | Header field observed in the demo file; trace the reader for exact storage and constraints. | - | - | - | - | `1` | demo/source inferred |
