---
title: constituents.cs input file
...
Input file for simulation; source slot cs_db.


## Official SWAT+ Reference

- Official page: [constituents.cs](https://swatplus.gitbook.io/io-docs/introduction-1/constituents/constituents.cs).
...
- Source inventory slot(s): `in_sim%cs_db = "constituents.cs"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `constituents.cs` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_sim%cs_db` defaulting to `constituents.cs`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/constit_db_read.f90`, `SWATPLUS/swatplus/src/gwflow_read.f90`, `SWATPLUS/swatplus/src/swift_output.f90`.
