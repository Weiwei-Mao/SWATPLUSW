...
This page is a source-aligned input-reference stub for `filterstrip.str`. It exists so `docs/inputs/` has a durable categorized page for each known SWAT+ input file or input-file family.
