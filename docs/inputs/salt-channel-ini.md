---
title: salt_channel.ini input file
...
Initial salt setup for channel salt simulation.

## Role In SWAT+

This page is a source-aligned input-reference stub for `salt_channel.ini`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
