...
- Activation: manifest file when `wnd.cli` is active.
...
Local demo evidence from `VSProj/SWAT/Osu_1hru/Imsilwind.wnd`:

- Title/comment line: `Imsilwind.wnd: Wind speed data - file written by SWAT+ editor 2023-03-22 04:22:29.234736`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `nbyr` | Length of the wind speed time series. | `integer` | `years` | - | - | `42` | official GitBook |
| `tstep` | Time step of the wind speed data. | `integer` | `n/a` | - | - | `0` | official GitBook |
| `lat` | Latitude of the wind speed station. | `real` | `Decimal Degrees` | - | - | `35.610` | official GitBook |
| `lon` | Longitude of the wind speed station. | `real` | `Decimal Degrees` | - | - | `127.290` | official GitBook |
| `elev` | Elevation of the wind speed station. | `real` | `m` | - | - | `247.900` | official GitBook |
...
- Activation evidence: manifest file when `wnd.cli` is active.
- Local file evidence: `VSProj/SWAT/Osu_1hru/Imsilwind.wnd`.
