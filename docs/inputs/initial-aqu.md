...
This page is a source-aligned input-reference stub for `initial.aqu`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
