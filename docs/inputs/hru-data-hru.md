...
This page is a source-aligned input-reference stub for `hru-data.hru`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
