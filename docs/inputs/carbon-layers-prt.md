---
title: carbon_layers.prt input file
...
Optional carbon-layer output control file.

## Role In SWAT+

This page is a source-aligned input-reference stub for `carbon_layers.prt`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
...
- Source inventory: carbon_layers_read.f90 fixed-name file.
