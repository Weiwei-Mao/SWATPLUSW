---
title: treatment.trt input file
...
Optional water-treatment or treatment-operation support file.

## Role In SWAT+

This page is a source-aligned input-reference stub for `treatment.trt`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
