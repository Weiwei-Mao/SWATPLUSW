...
Input file for calibration change; source slot codes_sft.


## Official SWAT+ Reference

- Official page: [codes.sft](https://swatplus.gitbook.io/io-docs/introduction-1/calibration/codes.sft).
...
- Source inventory slot(s): `in_chg%codes_sft = "codes.sft"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `codes.sft` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_chg%codes_sft` defaulting to `codes.sft`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/calsoft_read_codes.f90`.
