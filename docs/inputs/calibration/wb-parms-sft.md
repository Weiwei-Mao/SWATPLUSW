...
Input file for calibration change; source slot wb_parms_sft.


## Official SWAT+ Reference

- Official page: [wb_parms.sft](https://swatplus.gitbook.io/io-docs/introduction-1/calibration/wb_parms.sft).
...
- Source inventory slot(s): `in_chg%wb_parms_sft = "wb_parms.sft"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `wb_parms.sft` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_chg%wb_parms_sft` defaulting to `wb_parms.sft`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/ls_read_parms_cal.f90`.
