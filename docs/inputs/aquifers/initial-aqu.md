...
- Source inventory slot(s): `in_aqu%init = "initial.aqu"`.
...
Local demo evidence from `VSProj/SWAT/Osu_1hru/initial.aqu`:

- Title/comment line: `initial.aqu: written by SWAT+ editor v2.2.0 on 2023-03-22 04:25 for SWAT+ rev.60.5.4`.
...
- Source slot: `in_aqu%init` defaulting to `initial.aqu`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/aqu_read_init.f90`.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/initial.aqu`.
