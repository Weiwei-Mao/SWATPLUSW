---
title: salt_fertilizer.frt input file
...
Optional salt composition data for fertilizer-related salt simulation.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `salt_fertilizer.frt` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Candidate reader/source files: `SWATPLUS/swatplus/src/salt_fert_read.f90`.
