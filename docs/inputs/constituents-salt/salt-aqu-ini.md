...
Local demo evidence: `VSProj/SWAT/Osu_1hru/salt_aqu.ini` exists but is empty, so it proves presence only, not the data layout.
...
- Candidate reader/source files: `SWATPLUS/swatplus/src/salt_aqu_read.f90`.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/salt_aqu.ini`.
