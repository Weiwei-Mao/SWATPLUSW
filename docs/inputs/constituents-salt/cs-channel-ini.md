...
Local demo evidence: `VSProj/SWAT/Osu_1hru/cs_channel.ini` exists but is empty, so it proves presence only, not the data layout.
...
- Candidate reader/source files: `SWATPLUS/swatplus/src/cs_cha_read.f90`.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/cs_channel.ini`.
