...
Input file for regions; source slot def_res_reg.

## Role In SWAT+

This page is a source-aligned input-reference stub for `res_reg.def`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
