---
title: soils_lte.sol input file
...
Input file for soils; source slot lte_sol.
...
- Source inventory slot(s): `in_sol%lte_sol = "soils_lte.sol"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `soils_lte.sol` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_sol%lte_sol` defaulting to `soils_lte.sol`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/soil_lte_db_read.f90`.
