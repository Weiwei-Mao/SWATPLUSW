...
This page is a source-aligned input-reference stub for `co2.dat`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
...
- Source inventory: co2_read.f90 optional file.
