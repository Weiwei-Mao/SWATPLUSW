...
This page is a source-aligned input-reference stub for `exco.exc`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
