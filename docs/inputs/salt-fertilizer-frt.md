...
This page is a source-aligned input-reference stub for `salt_fertilizer.frt`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
...
- Source inventory: salt_fert_read.f90 fixed-name file.
