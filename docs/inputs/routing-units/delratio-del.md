...
This page is a source-aligned input-reference stub for `delratio.del`. It exists so `docs/inputs/` has a durable categorized page for each known SWAT+ input file or input-file family.
