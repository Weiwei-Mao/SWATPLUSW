...
Precipitation gauge list; points to precipitation time-series files.
...
- Official field metadata available: 11 field row(s); matched to 0 of 1 observed demo header field(s).
...
- Source inventory slot(s): `in_cli%pcp_cli = "pcp.cli"`.
...
Local demo evidence from `VSProj/SWAT/Osu_1hru/pcp.cli`:

- Title/comment line: `pcp.cli: Precipitation file names - file written by SWAT+ editor 2023-03-22 04:22:29.020522`.
- Observed header line: `filename`.
- Nonblank records after the header: 1.
- First demo data record: `Imsilpcp.pcp`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `filename` | Referenced input file name, normally relative to the scenario folder. | - | - | - | - | `Imsilpcp.pcp` | demo/source inferred |
...
- Source slot: `in_cli%pcp_cli` defaulting to `pcp.cli`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/cli_pmeas.f90`.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/pcp.cli`.
