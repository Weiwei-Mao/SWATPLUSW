...
Local demo evidence: `VSProj/SWAT/Osu_1hru/treatment.trt` exists but is empty, so it proves presence only, not the data layout.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/treatment.trt`.
