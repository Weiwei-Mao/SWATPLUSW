---
title: cs_channel.ini input file
...
Initial generic constituent setup for channel water/bed constituent simulation.

## Role In SWAT+

This page is a source-aligned input-reference stub for `cs_channel.ini`. It exists so `docs/inputs/` has a durable page for each known SWAT+ input file or input-file family.
...
- Source inventory: fixed-name optional module file.
