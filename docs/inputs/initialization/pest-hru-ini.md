...
Input file for initial conditions; source slot pest_soil.


## Official SWAT+ Reference

- Official page: [pest_hru.ini](https://swatplus.gitbook.io/io-docs/introduction-1/initialization/pest_hru.ini).
...
- Source inventory slot(s): `in_init%pest_soil = "pest_hru.ini"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `pest_hru.ini` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_init%pest_soil` defaulting to `pest_hru.ini`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/pest_hru_aqu_read.f90`.
