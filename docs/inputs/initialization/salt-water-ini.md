---
title: salt_water.ini input file
...
Input file for initial conditions; source slot salt_water.


## Official SWAT+ Reference

- Official page: [salt_water.ini](https://swatplus.gitbook.io/io-docs/introduction-1/initialization/salt_water.ini).
...
- Source inventory slot(s): `in_init%salt_water = "salt_water.ini"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `salt_water.ini` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_init%salt_water` defaulting to `salt_water.ini`.
