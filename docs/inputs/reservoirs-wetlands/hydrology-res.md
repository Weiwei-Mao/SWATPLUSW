---
title: hydrology.res input file
...
- Source inventory slot(s): `in_res%hyd_res = "hydrology.res"`.
...
Local demo evidence: the `Osu_1hru` scenario does not include a concrete `hydrology.res` file, or the file family is inactive there. Use another scenario or the reader routine for field-level confirmation.
...
- Source slot: `in_res%hyd_res` defaulting to `hydrology.res`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/res_read_hyd.f90`.
