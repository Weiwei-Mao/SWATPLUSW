---
title: fertilizer.frt input file
...
- Source inventory slot(s): `in_parmdb%fert_frt = "fertilizer.frt"`.
...
Local demo evidence from `VSProj/SWAT/Osu_1hru/fertilizer.frt`:

- Title/comment line: `fertilizer.frt: written by SWAT+ editor v2.2.0 on 2023-03-22 04:25 for SWAT+ rev.60.5.4`.
- Observed header line: `name                     min_n         min_p         org_n         org_p         nh3_n         pathogens  description`.
- Nonblank records after the header: 60.
- First demo data record: `elem_n                 1.00000       0.00000       0.00000       0.00000       0.00000              null  ElementalNitrogen`.
...
- Source slot: `in_parmdb%fert_frt` defaulting to `fertilizer.frt`.
- Candidate reader/source files: `SWATPLUS/swatplus/src/fert_parm_read.f90`.
...
- Local file evidence: `VSProj/SWAT/Osu_1hru/fertilizer.frt`.
