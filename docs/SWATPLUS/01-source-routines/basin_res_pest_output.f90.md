...
note_file: basin_res_pest_output.f90
...
uses_variables:
  ...
  - res_pesticide_module.f90#res_pestbz
...
## Basic Information
- **Type**: `subroutine`
- **Source file**: `basin_res_pest_output.f90`
- **Modules used**:
...
- [[res_pesticide_module.f90#res_pestbz]] - `res_pesticide_processes`
