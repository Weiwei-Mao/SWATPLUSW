...
note_file: res_read_salt_cs.f90
...
uses_variables:
  ...
  - reservoir_data_module.f90#res_dat_c_cs
input_variables:
  - reservoir_data_module.f90#res_dat_c_cs
reads:
  - reservoir.res_cs
...
## Basic Information
- **Type**: `subroutine`
- **Source file**: `res_read_salt_cs.f90`
- **Modules used**:
...
- [[reservoir_data_module.f90#res_dat_c_cs]] - `reservoir_data_char_input_cs`
