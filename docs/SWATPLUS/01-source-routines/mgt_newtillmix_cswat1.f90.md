...
tags:
  - swat/source
  - swat/to-read
file: mgt_newtillmix_cswat1.f90
note_file: mgt_newtillmix_cswat1.f90
subroutine: mgt_newtillmix_cswat1
module:
  - tillage_data_module
  - basin_module
...
## Basic Information
- **Type**: `subroutine`
- **Source file**: `mgt_newtillmix_cswat1.f90`
- **Modules used**: [[tillage_data_module.f90]], [[basin_module.f90]], [[organic_mineral_mass_module.f90]], [[hru_module.f90]], [[soil_module.f90]], [[constituent_mass_module.f90]], [[plant_module.f90]], [[plant_data_module.f90]]
