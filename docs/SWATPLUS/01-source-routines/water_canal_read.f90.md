...
note_file: water_canal_read.f90
...
calls: []
uses_variables:
  - constituent_mass_module.f90#canal_cs_stor
...
## Basic Information
- **Type**: `subroutine`
- **Source file**: `water_canal_read.f90`
- **Modules used**:
...
- [[constituent_mass_module.f90#canal_cs_stor]] - `constituent_mass`
