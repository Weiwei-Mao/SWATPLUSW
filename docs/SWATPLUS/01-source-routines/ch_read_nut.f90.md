...
- **Modules used**: [[input_file_module.f90]], [[basin_module.f90]], [[time_module.f90]], [[maximum_data_module.f90]], [[channel_data_module.f90]]
...
## File I/O
- **Reads**: `in_cha%nut` _(variable; see file.cio)_
