...
- **Modules used**: [[septic_data_module.f90]], [[basin_module.f90]], [[organic_mineral_mass_module.f90]], [[hru_module.f90]], [[soil_module.f90]], [[plant_module.f90]], [[plant_data_module.f90]], [[output_landscape_module.f90]], [[carbon_module.f90]]
