...
- **类型**：`subroutine`
- **源文件**：`cs_rain.f90`
- **使用模块**：[[basin_module.f90]]、[[organic_mineral_mass_module.f90]]、[[hydrograph_module.f90]]、[[hru_module.f90]]、[[climate_module.f90]]、[[output_landscape_module.f90]]、[[cs_module.f90]]、[[constituent_mass_module.f90]]
