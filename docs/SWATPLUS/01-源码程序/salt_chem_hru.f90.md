...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`salt_chem_hru.f90`
- **使用模块**：[[hru_module.f90]]、[[basin_module.f90]]、[[constituent_mass_module.f90]]、[[salt_data_module.f90]]、[[soil_module.f90]]、[[salt_module.f90]]、[[time_module.f90]]、[[organic_mineral_mass_module.f90]]
