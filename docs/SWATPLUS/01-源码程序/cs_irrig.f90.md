...
- **类型**：`subroutine`
- **源文件**：`cs_irrig.f90`
- **使用模块**：[[water_allocation_module.f90]]、[[water_body_module.f90]]、[[aquifer_module.f90]]、[[reservoir_data_module.f90]]、[[hydrograph_module.f90]]、[[hru_module.f90]]、[[cs_module.f90]]、[[cs_aquifer.f90]]、[[ch_cs_module.f90]]、[[res_cs_module.f90]]、[[basin_module.f90]]、[[constituent_mass_module.f90]]
