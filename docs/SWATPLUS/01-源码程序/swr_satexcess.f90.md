...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`swr_satexcess.f90`
- **使用模块**：[[hru_module.f90]]、[[soil_module.f90]]、[[hydrograph_module.f90]]、[[basin_module.f90]]、[[organic_mineral_mass_module.f90]]、[[gwflow_module.f90]]、[[reservoir_module.f90]]
