...
- **类型**：`subroutine`
- **源文件**：`pest_lch.f90`
- **使用模块**：[[pesticide_data_module.f90]]、[[basin_module.f90]]、[[hru_module.f90]]、[[soil_module.f90]]、[[constituent_mass_module.f90]]、[[output_ls_pesticide_module.f90]]、[[organic_mineral_mass_module.f90]]
