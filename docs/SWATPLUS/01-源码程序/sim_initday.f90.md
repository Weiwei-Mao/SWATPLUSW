...
- **类型**：`subroutine`
- **源文件**：`sim_initday.f90`
- **使用模块**：[[hru_module.f90]]、[[soil_module.f90]]、[[organic_mineral_mass_module.f90]]、[[carbon_module.f90]]、[[hydrograph_module.f90]]、[[reservoir_module.f90]]、[[maximum_data_module.f90]]、[[res_cs_module.f90]]
