...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`salt_chem_aqu.f90`
- **使用模块**：[[aquifer_module.f90]]、[[basin_module.f90]]、[[constituent_mass_module.f90]]、[[salt_data_module.f90]]、[[soil_module.f90]]、[[hydrograph_module.f90]]、[[salt_module.f90]]、[[salt_aquifer.f90]]
