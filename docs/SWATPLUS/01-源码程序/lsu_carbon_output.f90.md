...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`lsu_carbon_output.f90`
- **使用模块**：[[time_module.f90]]、[[basin_module.f90]]、[[maximum_data_module.f90]]、[[calibration_data_module.f90]]、[[hydrograph_module.f90]]、[[carbon_module.f90]]、[[plant_module.f90]]、[[organic_mineral_mass_module.f90]]、[[output_landscape_module.f90]]
