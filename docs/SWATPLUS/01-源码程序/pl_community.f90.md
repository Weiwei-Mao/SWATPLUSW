...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`pl_community.f90`
- **使用模块**：[[hru_module.f90]]、[[soil_module.f90]]、[[plant_module.f90]]、[[plant_data_module.f90]]、[[organic_mineral_mass_module.f90]]、[[time_module.f90]]、[[climate_module.f90]]
