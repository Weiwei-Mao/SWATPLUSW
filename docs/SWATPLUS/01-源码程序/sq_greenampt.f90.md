...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`sq_greenampt.f90`
- **使用模块**：[[urban_data_module.f90]]、[[climate_module.f90]]、[[basin_module.f90]]、[[hydrograph_module.f90]]、[[hru_module.f90]]、[[soil_module.f90]]、[[time_module.f90]]
