...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`mgt_harvbiomass.f90`
- **使用模块**：[[organic_mineral_mass_module.f90]]、[[soil_module.f90]]、[[plant_module.f90]]、[[plant_data_module.f90]]、[[mgt_operations_module.f90]]、[[constituent_mass_module.f90]]、[[carbon_module.f90]]
