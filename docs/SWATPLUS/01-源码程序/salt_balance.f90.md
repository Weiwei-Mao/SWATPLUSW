...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`salt_balance.f90`
- **使用模块**：[[hydrograph_module.f90]]、[[organic_mineral_mass_module.f90]]、[[output_landscape_module.f90]]、[[aquifer_module.f90]]、[[hru_module.f90]]、[[soil_module.f90]]、[[time_module.f90]]、[[salt_module.f90]]、[[salt_aquifer.f90]]、[[constituent_mass_module.f90]]、[[res_salt_module.f90]]、[[ch_salt_module.f90]]、[[gwflow_module.f90]]
