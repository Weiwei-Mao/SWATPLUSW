...
## 基本信息
- **类型**：`subroutine`
- **源文件**：`soil_nutcarb_init.f90`
- **使用模块**：[[hru_module.f90]]、[[soil_module.f90]]、[[soil_data_module.f90]]、[[basin_module.f90]]、[[organic_mineral_mass_module.f90]]、[[carbon_module.f90]]、[[tillage_data_module.f90]]
