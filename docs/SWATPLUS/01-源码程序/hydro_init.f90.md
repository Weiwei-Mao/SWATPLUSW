...
- **类型**：`subroutine`
- **源文件**：`hydro_init.f90`
- **使用模块**：[[hru_module.f90]]、[[soil_module.f90]]、[[plant_module.f90]]、[[climate_module.f90]]、[[plant_data_module.f90]]、[[pesticide_data_module.f90]]、[[basin_module.f90]]、[[channel_module.f90]]、[[time_module.f90]]、[[organic_mineral_mass_module.f90]]、[[hydrograph_module.f90]]、[[constituent_mass_module.f90]]、[[output_landscape_module.f90]]
